  ...
  <div class="article-detail">
    ...
    <div class="article-header">
      ...
      <div class="info">
        ...
        <div
          class="view-info"
        >文章数 {{selfCard.articleQuantity || 0}}&nbsp;&nbsp;&nbsp;视频数 {{selfCard.videoQuantity || 0}}&nbsp;&nbsp;&nbsp;浏览量 {{selfCard.pageView || 0}}</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    getArticleProducts() {
      ...
      axios.post(this.$apiConfig.getArticleProducts, params).then(res => {
        if (res.data.code == 0) {
      ...
      axios.post(this.$apiConfig.getArticleContent, params).then(res => {
        if (res.data.code == 0) {
          ...
          this.wxShareAll(
            ...
            this.article.newsIntroduce,
            url,
            this.article.newsThumbnail,
            function(res1) {
              _this.axios
                .post(_this.$apiConfig.shareNew, params)
                .then(res1 => {});
            }
          );
        }
